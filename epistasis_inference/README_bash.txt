...
"g++ -std=c++11 -lgslcblas -lgsl -I ./eigen-3.4.0/ get_freq.cpp -o get_freq": compile the C++ script about freqeucny extraction from the raw data files. 
...
“g++ -std=c++11 -lgslcblas -lgsl -I ./eigen-3.4.0/ inversion.cpp -o inversion”: compling the inversion.cpp to estimate the fitness for single replicate with intermediate files.

“./inversion [Target-protein] [genoype counts data file] [target protein indexing file name] [raw sequence file] [regularization magnitude]”, which in this analysis is “./inversion YAP1 ./YAP1_haplotype_count_rep1.csv index_matrix.csv ./YAP1_Reference_AA_sequence.txt 100”. This will generate the epistasis output in  [Target_protein]_epistasis_rep[replicate_num].txt within ./epistasis_inference/ directory. In this example, the output file name is YAP1_epistasis_rep1.txt.

“g++ -std=c++11 -lgslcblas -lgsl -I ./eigen-3.4.0/ inversion_joint.cpp -o inversion_joint”: compling the inversion.cpp to estimate the fitness for multiple replicates with intermediate files.
